...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../Common/F2837xD_CpuTimers.c")
...
$C$DW$6	.dwtag  DW_TAG_variable
	...
	.sblock	".ebss"
;	C:\ti\ccsv8\tools\compiler\ti-cgt-c2000_18.1.4.LTS\bin\ac2000.exe -@C:\\Users\\Claudine\\AppData\\Local\\Temp\\{648F0B60-AD5B-48C1-B050-0025F3EEF592} 
	.sect	".text"
	.clink
...
$C$DW$7	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$7, DW_AT_TI_begin_file("../Common/F2837xD_CpuTimers.c")
	.dwattr $C$DW$7, DW_AT_TI_begin_line(0x1f)
	.dwattr $C$DW$7, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$7, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 32,column 1,is_stmt,address _InitCpuTimers,isa 0

	.dwfde $C$DW$CIE, _InitCpuTimers
;----------------------------------------------------------------------
;  31 | void InitCpuTimers(void)                                               
;  33 | //                                                                     
;  34 | // CPU Timer 0                                                         
...
_InitCpuTimers:
	...
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 37,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  37 | CpuTimer0.RegsAddr = &CpuTimer0Regs;                                   
;  39 | //                                                                     
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 42,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  42 | CpuTimer0Regs.PRD.all  = 0xFFFFFFFF;                                   
;  44 | //                                                                     
;  45 | // Initialize pre-scale counter to divide by 1 (SYSCLKOUT):            
;  46 | //                                                                     
;----------------------------------------------------------------------
	...
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 47,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  47 | CpuTimer0Regs.TPR.all  = 0;                                            
;----------------------------------------------------------------------
        MOV       @_CpuTimer0Regs+6,#0  ; [CPU_ALU] |47| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 48,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  48 | CpuTimer0Regs.TPRH.all = 0;                                            
;  50 | //                                                                     
;  51 | // Make sure timer is stopped:                                         
;  52 | //                                                                     
;----------------------------------------------------------------------
        MOV       @_CpuTimer0Regs+7,#0  ; [CPU_ALU] |48| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 53,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  53 | CpuTimer0Regs.TCR.bit.TSS = 1;                                         
;  55 | //                                                                     
;  56 | // Reload all counter register with period value:                      
;  57 | //                                                                     
;----------------------------------------------------------------------
        OR        @_CpuTimer0Regs+4,#0x0010 ; [CPU_ALU] |53| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 58,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  58 | CpuTimer0Regs.TCR.bit.TRB = 1;                                         
;  60 | //                                                                     
;  61 | // Reset interrupt counters:                                           
;  62 | //                                                                     
;----------------------------------------------------------------------
        OR        @_CpuTimer0Regs+4,#0x0020 ; [CPU_ALU] |58| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 63,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  63 | CpuTimer0.InterruptCount = 0;                                          
;  65 | //                                                                     
;  66 | // Initialize address pointers to respective timer registers:          
;  67 | //                                                                     
;----------------------------------------------------------------------
        MOVB      ACC,#0                ; [CPU_ALU] |63| 
        MOVW      DP,#_CpuTimer0+2      ; [CPU_ARAU] 
        MOVL      @_CpuTimer0+2,ACC     ; [CPU_ALU] |63| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 68,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  68 | CpuTimer1.RegsAddr = &CpuTimer1Regs;                                   
;----------------------------------------------------------------------
        MOVL      XAR4,#_CpuTimer1Regs  ; [CPU_ARAU] |68| 
        MOVL      @_CpuTimer1,XAR4      ; [CPU_ALU] |68| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 69,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  69 | CpuTimer2.RegsAddr = &CpuTimer2Regs;                                   
;  71 | //                                                                     
;  72 | // Initialize timer period to maximum:                                 
;  73 | //                                                                     
;----------------------------------------------------------------------
        MOVL      XAR4,#_CpuTimer2Regs  ; [CPU_ARAU] |69| 
        MOVL      @_CpuTimer2,XAR4      ; [CPU_ALU] |69| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 74,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  74 | CpuTimer1Regs.PRD.all  = 0xFFFFFFFF;                                   
;----------------------------------------------------------------------
        MOVW      DP,#_CpuTimer1Regs+2  ; [CPU_ARAU] 
        SUBB      ACC,#1                ; [CPU_ALU] |74| 
        MOVL      @_CpuTimer1Regs+2,ACC ; [CPU_ALU] |74| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 75,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  75 | CpuTimer2Regs.PRD.all  = 0xFFFFFFFF;                                   
;  77 | //                                                                     
;  78 | // Initialize pre-scale counter to divide by 1 (SYSCLKOUT):            
;  79 | //                                                                     
;----------------------------------------------------------------------
	...
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 80,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  80 | CpuTimer1Regs.TPR.all  = 0;                                            
;----------------------------------------------------------------------
        MOVW      DP,#_CpuTimer1Regs+6  ; [CPU_ARAU] 
        MOV       @_CpuTimer1Regs+6,#0  ; [CPU_ALU] |80| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 81,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  81 | CpuTimer1Regs.TPRH.all = 0;                                            
;----------------------------------------------------------------------
        MOV       @_CpuTimer1Regs+7,#0  ; [CPU_ALU] |81| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 82,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  82 | CpuTimer2Regs.TPR.all  = 0;                                            
;----------------------------------------------------------------------
        MOVW      DP,#_CpuTimer2Regs+6  ; [CPU_ARAU] 
        MOV       @_CpuTimer2Regs+6,#0  ; [CPU_ALU] |82| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 83,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  83 | CpuTimer2Regs.TPRH.all = 0;                                            
;  85 | //                                                                     
;  86 | // Make sure timers are stopped:                                       
;  87 | //                                                                     
;----------------------------------------------------------------------
        MOV       @_CpuTimer2Regs+7,#0  ; [CPU_ALU] |83| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 88,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  88 | CpuTimer1Regs.TCR.bit.TSS = 1;                                         
;----------------------------------------------------------------------
        MOVW      DP,#_CpuTimer1Regs+4  ; [CPU_ARAU] 
        OR        @_CpuTimer1Regs+4,#0x0010 ; [CPU_ALU] |88| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 89,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  89 | CpuTimer2Regs.TCR.bit.TSS = 1;                                         
;  91 | //                                                                     
;  92 | // Reload all counter register with period value:                      
;  93 | //                                                                     
;----------------------------------------------------------------------
        MOVW      DP,#_CpuTimer2Regs+4  ; [CPU_ARAU] 
        OR        @_CpuTimer2Regs+4,#0x0010 ; [CPU_ALU] |89| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 94,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  94 | CpuTimer1Regs.TCR.bit.TRB = 1;                                         
;----------------------------------------------------------------------
        MOVW      DP,#_CpuTimer1Regs+4  ; [CPU_ARAU] 
        OR        @_CpuTimer1Regs+4,#0x0020 ; [CPU_ALU] |94| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 95,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  95 | CpuTimer2Regs.TCR.bit.TRB = 1;                                         
;  97 | //                                                                     
;  98 | // Reset interrupt counters:                                           
;  99 | //                                                                     
;----------------------------------------------------------------------
        MOVW      DP,#_CpuTimer2Regs+4  ; [CPU_ARAU] 
        OR        @_CpuTimer2Regs+4,#0x0020 ; [CPU_ALU] |95| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 100,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 100 | CpuTimer1.InterruptCount = 0;                                          
;----------------------------------------------------------------------
        MOVW      DP,#_CpuTimer1+2      ; [CPU_ARAU] 
        MOVB      ACC,#0                ; [CPU_ALU] |100| 
        MOVL      @_CpuTimer1+2,ACC     ; [CPU_ALU] |100| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 101,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 101 | CpuTimer2.InterruptCount = 0;                                          
;----------------------------------------------------------------------
        MOVL      @_CpuTimer2+2,ACC     ; [CPU_ALU] |101| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 102,column 1,is_stmt,isa 0
$C$DW$8	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$8, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$7, DW_AT_TI_end_file("../Common/F2837xD_CpuTimers.c")
...
$C$DW$9	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$9, DW_AT_TI_begin_file("../Common/F2837xD_CpuTimers.c")
	.dwattr $C$DW$9, DW_AT_TI_begin_line(0x6e)
	.dwattr $C$DW$9, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$9, DW_AT_TI_max_frame_size(-10)
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 111,column 1,is_stmt,address _ConfigCpuTimer,isa 0
...
;----------------------------------------------------------------------
; 110 | void ConfigCpuTimer(struct CPUTIMER_VARS *Timer, float Freq, float Peri
;     | od)                                                                    
;----------------------------------------------------------------------
...
; 112 | Uint32 temp;                                                           
; 114 | //                                                                     
; 115 | // Initialize timer period:                                            
; 116 | //                                                                     
;----------------------------------------------------------------------
        MOV32     *-SP[6],R1H           ; [CPU_FPU] |111| 
        MOV32     *-SP[4],R0H           ; [CPU_FPU] |111| 
        MOVL      *-SP[2],XAR4          ; [CPU_ALU] |111| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 117,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 117 | Timer->CPUFreqInMHz = Freq;                                            
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[4]           ; [CPU_ALU] |117| 
        MOVL      *+XAR4[4],ACC         ; [CPU_ALU] |117| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 118,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 118 | Timer->PeriodInUSec = Period;                                          
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[2]          ; [CPU_ALU] |118| 
        MOVL      ACC,*-SP[6]           ; [CPU_ALU] |118| 
        MOVL      *+XAR4[6],ACC         ; [CPU_ALU] |118| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 119,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 119 | temp = (long) (Freq * Period);                                         
; 121 | //                                                                     
; 122 | // Counter decrements PRD+1 times each period                          
; 123 | //                                                                     
;----------------------------------------------------------------------
	...
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 124,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 124 | Timer->RegsAddr->PRD.all = temp - 1;                                   
; 126 | //                                                                     
; 127 | // Set pre-scale counter to divide by 1 (SYSCLKOUT):                   
; 128 | //                                                                     
;----------------------------------------------------------------------
	...
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 129,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 129 | Timer->RegsAddr->TPR.all  = 0;                                         
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[2]          ; [CPU_ALU] |129| 
        MOVL      XAR4,*+XAR4[0]        ; [CPU_ALU] |129| 
        MOV       *+XAR4[6],#0          ; [CPU_ALU] |129| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 130,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 130 | Timer->RegsAddr->TPRH.all  = 0;                                        
; 132 | //                                                                     
; 133 | // Initialize timer control register:                                  
; 134 | //                                                                     
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[2]          ; [CPU_ALU] |130| 
        MOVL      XAR4,*+XAR4[0]        ; [CPU_ALU] |130| 
        MOV       *+XAR4[7],#0          ; [CPU_ALU] |130| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 135,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 135 | Timer->RegsAddr->TCR.bit.TSS = 1;     // 1 = Stop timer, 0 = Start/Rest
;     | art                                                                    
; 136 |                                       // Timer                         
;----------------------------------------------------------------------
	...
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 137,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 137 | Timer->RegsAddr->TCR.bit.TRB = 1;     // 1 = reload timer              
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[2]          ; [CPU_ALU] |137| 
        MOVL      XAR4,*+XAR4[0]        ; [CPU_ALU] |137| 
        OR        *+XAR4[4],#0x0020     ; [CPU_ALU] |137| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 138,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 138 | Timer->RegsAddr->TCR.bit.SOFT = 0;                                     
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[2]          ; [CPU_ALU] |138| 
        MOVL      XAR4,*+XAR4[0]        ; [CPU_ALU] |138| 
        AND       *+XAR4[4],#0xfbff     ; [CPU_ALU] |138| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 139,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 139 | Timer->RegsAddr->TCR.bit.FREE = 0;    // Timer Free Run Disabled       
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[2]          ; [CPU_ALU] |139| 
        MOVL      XAR4,*+XAR4[0]        ; [CPU_ALU] |139| 
        AND       *+XAR4[4],#0xf7ff     ; [CPU_ALU] |139| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 140,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 140 | Timer->RegsAddr->TCR.bit.TIE = 1;     // 0 = Disable/ 1 = Enable Timer 
; 141 |                                       // Interrupt                     
; 143 | //                                                                     
; 144 | // Reset interrupt counter:                                            
; 145 | //                                                                     
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[2]          ; [CPU_ALU] |140| 
        MOVL      XAR4,*+XAR4[0]        ; [CPU_ALU] |140| 
        OR        *+XAR4[4],#0x4000     ; [CPU_ALU] |140| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 146,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 146 | Timer->InterruptCount = 0;                                             
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[2]          ; [CPU_ALU] |146| 
        MOVB      ACC,#0                ; [CPU_ALU] |146| 
        MOVL      *+XAR4[2],ACC         ; [CPU_ALU] |146| 
	.dwpsn	file "../Common/F2837xD_CpuTimers.c",line 147,column 1,is_stmt,isa 0
        SUBB      SP,#8                 ; [CPU_ARAU] 
	.dwcfi	cfa_offset, -2
$C$DW$17	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$17, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$9, DW_AT_TI_end_file("../Common/F2837xD_CpuTimers.c")
