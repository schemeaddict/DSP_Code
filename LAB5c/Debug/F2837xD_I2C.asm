...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../Common/F2837xD_I2C.c")
...
;	C:\ti\ccsv8\tools\compiler\ti-cgt-c2000_18.1.4.LTS\bin\ac2000.exe -@C:\\Users\\Claudine\\AppData\\Local\\Temp\\{E3BE4D6A-CEAE-4F9A-9531-2E1F60D9A6D1} 
	.sect	".text"
	.clink
...
$C$DW$2	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$2, DW_AT_TI_begin_file("../Common/F2837xD_I2C.c")
	.dwattr $C$DW$2, DW_AT_TI_begin_line(0x26)
	.dwattr $C$DW$2, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$2, DW_AT_TI_max_frame_size(-4)
	.dwpsn	file "../Common/F2837xD_I2C.c",line 39,column 1,is_stmt,address _I2cAGpioConfig,isa 0
...
;----------------------------------------------------------------------
;  38 | void I2cAGpioConfig(Uint16 I2caDataClkPin)                             
;----------------------------------------------------------------------
...
$C$DW$4	.dwtag  DW_TAG_variable
	...
	.dwpsn	file "../Common/F2837xD_I2C.c",line 40,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  40 | EALLOW;                                                                
;----------------------------------------------------------------------
 EALLOW
	.dwpsn	file "../Common/F2837xD_I2C.c",line 42,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  42 | switch(I2caDataClkPin)                                                 
;  44 |     case I2C_A_GPIO0_GPIO1:                                            
;  46 |         //                                                             
;  47 |         // Enable internal pull-up for the selected I2C pins           
;  48 |         // Enable pull-up for GPIO0 (SDAA)                             
;  49 |         // Enable pull-up for GPIO1 (SDLA)                             
;  50 |         //                                                             
;----------------------------------------------------------------------
        B         $C$L4,UNC             ; [CPU_ALU] |42| 
        ; branch occurs ; [] |42| 
$C$L1:    
	.dwpsn	file "../Common/F2837xD_I2C.c",line 51,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  51 | GpioCtrlRegs.GPAPUD.bit.GPIO0 = 0;                                     
;----------------------------------------------------------------------
        MOVW      DP,#_GpioCtrlRegs+12  ; [CPU_ARAU] 
        AND       @_GpioCtrlRegs+12,#0xfffe ; [CPU_ALU] |51| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 52,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  52 | GpioCtrlRegs.GPAPUD.bit.GPIO1 = 0;                                     
;  54 | //                                                                     
;  55 | // Set qualification for the selected I2C pins                         
;  56 | // Async/no qualification (I/ps sync to SYSCLKOUT by default)          
;  57 | //                                                                     
;----------------------------------------------------------------------
        AND       @_GpioCtrlRegs+12,#0xfffd ; [CPU_ALU] |52| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 58,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  58 | GpioCtrlRegs.GPAQSEL1.bit.GPIO0 = 3;                                   
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+2,#0x0003 ; [CPU_ALU] |58| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 59,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  59 | GpioCtrlRegs.GPAQSEL1.bit.GPIO1 = 3;                                   
;  61 | //                                                                     
;  62 | // Configure which of the possible GPIO pins will be I2C_A pins        
;  63 | // using GPIO regs                                                     
;  64 | // Configure GPIO0 for SDAA operation                                  
;  65 | // Configure GPIO0 for SDAA operation                                  
;  66 | //                                                                     
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+2,#0x000c ; [CPU_ALU] |59| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 67,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  67 | GpioCtrlRegs.GPAGMUX1.bit.GPIO0 = 1;                                   
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+32,#0xfffc ; [CPU_ALU] |67| 
        ORB       AL,#0x01              ; [CPU_ALU] |67| 
        MOV       @_GpioCtrlRegs+32,AL  ; [CPU_ALU] |67| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 68,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  68 | GpioCtrlRegs.GPAMUX1.bit.GPIO0  = 2;                                   
;  70 | //                                                                     
;  71 | // Configure GPIO1 for SDLA operation                                  
;  72 | // Configure GPIO1 for SDLA operation                                  
;  73 | //                                                                     
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+6,#0xfffc ; [CPU_ALU] |68| 
        ORB       AL,#0x02              ; [CPU_ALU] |68| 
        MOV       @_GpioCtrlRegs+6,AL   ; [CPU_ALU] |68| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 74,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  74 | GpioCtrlRegs.GPAGMUX1.bit.GPIO1 = 1;                                   
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+32,#0xfff3 ; [CPU_ALU] |74| 
        ORB       AL,#0x04              ; [CPU_ALU] |74| 
        MOV       @_GpioCtrlRegs+32,AL  ; [CPU_ALU] |74| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 75,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  75 | GpioCtrlRegs.GPAMUX1.bit.GPIO1  = 2;                                   
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+6,#0xfff3 ; [CPU_ALU] |75| 
        ORB       AL,#0x08              ; [CPU_ALU] |75| 
        MOV       @_GpioCtrlRegs+6,AL   ; [CPU_ALU] |75| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 77,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  77 | break;                                                                 
;  79 | case I2C_A_GPIO32_GPIO33:                                              
;  80 | //                                                                     
;  81 | // Enable internal pull-up for the selected I2C pins                   
;  82 | //                                                                     
;----------------------------------------------------------------------
        B         $C$L6,UNC             ; [CPU_ALU] |77| 
        ; branch occurs ; [] |77| 
$C$L2:    
	.dwpsn	file "../Common/F2837xD_I2C.c",line 83,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  83 | GpioCtrlRegs.GPBPUD.bit.GPIO32 = 0;                                    
;----------------------------------------------------------------------
        MOVW      DP,#_GpioCtrlRegs+76  ; [CPU_ARAU] 
        AND       @_GpioCtrlRegs+76,#0xfffe ; [CPU_ALU] |83| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 84,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  84 | GpioCtrlRegs.GPBPUD.bit.GPIO33 = 0;                                    
;  86 | //                                                                     
;  87 | // Set qualification for the selected I2C pins                         
;  88 | //                                                                     
;----------------------------------------------------------------------
        AND       @_GpioCtrlRegs+76,#0xfffd ; [CPU_ALU] |84| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 89,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  89 | GpioCtrlRegs.GPBQSEL1.bit.GPIO32 = 3;                                  
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+66,#0x0003 ; [CPU_ALU] |89| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 90,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  90 | GpioCtrlRegs.GPBQSEL1.bit.GPIO33 = 3;                                  
;  92 | //                                                                     
;  93 | // Configure which of the possible GPIO pins will be I2C_A pins        
;  94 | // using GPIO regs                                                     
;  95 | //                                                                     
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+66,#0x000c ; [CPU_ALU] |90| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 96,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  96 | GpioCtrlRegs.GPBMUX1.bit.GPIO32 = 1;                                   
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+70,#0xfffc ; [CPU_ALU] |96| 
        ORB       AL,#0x01              ; [CPU_ALU] |96| 
        MOV       @_GpioCtrlRegs+70,AL  ; [CPU_ALU] |96| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 97,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  97 | GpioCtrlRegs.GPBMUX1.bit.GPIO33 = 1;                                   
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+70,#0xfff3 ; [CPU_ALU] |97| 
        ORB       AL,#0x04              ; [CPU_ALU] |97| 
        MOV       @_GpioCtrlRegs+70,AL  ; [CPU_ALU] |97| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 99,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
;  99 | break;                                                                 
; 101 | case I2C_A_GPIO42_GPIO43:                                              
; 102 | //                                                                     
; 103 | // Enable internal pull-up for the selected I2C pins                   
; 104 | //                                                                     
; 106 | //                                                                     
; 107 | // Set qualification for the selected I2C pins                         
; 108 | //                                                                     
; 110 | //                                                                     
; 111 | // Configure which of the possible GPIO pins will be I2C_A pins        
; 112 | // using GPIO regs                                                     
; 113 | //                                                                     
; 114 | break;                                                                 
; 116 | case I2C_A_GPIO91_GPIO92:                                              
; 117 | //                                                                     
...
;----------------------------------------------------------------------
        ...
        ; branch occurs ; [] |99| 
$C$L3:    
	.dwpsn	file "../Common/F2837xD_I2C.c",line 120,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 120 | GpioCtrlRegs.GPCPUD.bit.GPIO91 = 0;                                    
;----------------------------------------------------------------------
        MOVW      DP,#_GpioCtrlRegs+141 ; [CPU_ARAU] 
        AND       @_GpioCtrlRegs+141,#0xf7ff ; [CPU_ALU] |120| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 121,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 121 | GpioCtrlRegs.GPCPUD.bit.GPIO92 = 0;                                    
; 123 | //                                                                     
; 124 | // Set qualification for the selected I2C pins                         
; 125 | //                                                                     
;----------------------------------------------------------------------
        AND       @_GpioCtrlRegs+141,#0xefff ; [CPU_ALU] |121| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 126,column 16,is_stmt,isa 0
;----------------------------------------------------------------------
; 126 | GpioCtrlRegs.GPCQSEL2.bit.GPIO91 = 3;                                  
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+133,#0x00c0 ; [CPU_ALU] |126| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 127,column 16,is_stmt,isa 0
;----------------------------------------------------------------------
; 127 | GpioCtrlRegs.GPCQSEL2.bit.GPIO92 = 3;                                  
; 129 | //                                                                     
; 130 | // Configure which of the possible GPIO pins will be I2C_A pins        
; 131 | // using GPIO regs                                                     
; 132 | //                                                                     
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+133,#0x0300 ; [CPU_ALU] |127| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 133,column 16,is_stmt,isa 0
;----------------------------------------------------------------------
; 133 | GpioCtrlRegs.GPCGMUX2.bit.GPIO91 = 1;                                  
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+163,#0xff3f ; [CPU_ALU] |133| 
        ORB       AL,#0x40              ; [CPU_ALU] |133| 
        MOV       @_GpioCtrlRegs+163,AL ; [CPU_ALU] |133| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 134,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 134 | GpioCtrlRegs.GPCMUX2.bit.GPIO91 = 2;                                   
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+137,#0xff3f ; [CPU_ALU] |134| 
        ORB       AL,#0x80              ; [CPU_ALU] |134| 
        MOV       @_GpioCtrlRegs+137,AL ; [CPU_ALU] |134| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 135,column 16,is_stmt,isa 0
;----------------------------------------------------------------------
; 135 | GpioCtrlRegs.GPCGMUX2.bit.GPIO92 = 1;                                  
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+163,#0xfcff ; [CPU_ALU] |135| 
        OR        AL,#0x0100            ; [CPU_ALU] |135| 
        MOV       @_GpioCtrlRegs+163,AL ; [CPU_ALU] |135| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 136,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 136 | GpioCtrlRegs.GPCMUX2.bit.GPIO92 = 2;                                   
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+137,#0xfcff ; [CPU_ALU] |136| 
        OR        AL,#0x0200            ; [CPU_ALU] |136| 
        MOV       @_GpioCtrlRegs+137,AL ; [CPU_ALU] |136| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 137,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 137 | break;                                                                 
; 139 | case I2C_A_GPIO63104_GPIO105:                                          
; 140 | //                                                                     
; 141 | // Enable internal pull-up for the selected I2C pins                   
; 142 | //                                                                     
; 144 | //                                                                     
; 145 | // Set qualification for the selected I2C pins                         
; 146 | //                                                                     
; 148 | //                                                                     
; 149 | // Configure which of the possible GPIO pins will be I2C_A pins        
; 150 | // using GPIO regs                                                     
; 151 | //                                                                     
; 152 | break;                                                                 
; 154 | default:                                                               
...
$C$L5:    
        ...
        ; branchcc occurs ; [] |42| 
$C$L6:    
	.dwpsn	file "../Common/F2837xD_I2C.c",line 159,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 159 | EDIS;                                                                  
;----------------------------------------------------------------------
 EDIS
	.dwpsn	file "../Common/F2837xD_I2C.c",line 160,column 1,is_stmt,isa 0
        SUBB      SP,#2                 ; [CPU_ARAU] 
	.dwcfi	cfa_offset, -2
        SPM       #0                    ; [CPU_ALU] 
$C$DW$5	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$5, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$2, DW_AT_TI_end_file("../Common/F2837xD_I2C.c")
...
$C$DW$6	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$6, DW_AT_TI_begin_file("../Common/F2837xD_I2C.c")
	.dwattr $C$DW$6, DW_AT_TI_begin_line(0xa8)
	.dwattr $C$DW$6, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$6, DW_AT_TI_max_frame_size(-4)
	.dwpsn	file "../Common/F2837xD_I2C.c",line 169,column 1,is_stmt,address _I2cBGpioConfig,isa 0
...
;----------------------------------------------------------------------
; 168 | void I2cBGpioConfig(Uint16 I2cbDataClkPin)                             
;----------------------------------------------------------------------
...
$C$DW$8	.dwtag  DW_TAG_variable
	...
	.dwpsn	file "../Common/F2837xD_I2C.c",line 170,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 170 | EALLOW;                                                                
;----------------------------------------------------------------------
 EALLOW
	.dwpsn	file "../Common/F2837xD_I2C.c",line 172,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 172 | switch(I2cbDataClkPin)                                                 
; 174 |     case I2C_B_GPIO2_GPIO3:                                            
; 175 |         //                                                             
; 176 |         // Enable internal pull-up for the selected I2C pins           
; 177 |         // Enable pull-up for GPIO2 (SDAB)                             
; 178 |         // Enable pull-up for GPIO3 (SDLB)                             
; 179 |         //                                                             
;----------------------------------------------------------------------
        B         $C$L9,UNC             ; [CPU_ALU] |172| 
        ; branch occurs ; [] |172| 
$C$L7:    
	.dwpsn	file "../Common/F2837xD_I2C.c",line 180,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 180 | GpioCtrlRegs.GPAPUD.bit.GPIO2 = 0;                                     
;----------------------------------------------------------------------
        MOVW      DP,#_GpioCtrlRegs+12  ; [CPU_ARAU] 
        AND       @_GpioCtrlRegs+12,#0xfffb ; [CPU_ALU] |180| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 181,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 181 | GpioCtrlRegs.GPAPUD.bit.GPIO3 = 0;                                     
; 183 | //                                                                     
; 184 | // Set qualification for the selected I2C pins                         
; 185 | // Async/no qualification (I/ps sync to SYSCLKOUT by default)          
; 186 | //                                                                     
;----------------------------------------------------------------------
        AND       @_GpioCtrlRegs+12,#0xfff7 ; [CPU_ALU] |181| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 187,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 187 | GpioCtrlRegs.GPAQSEL1.bit.GPIO2 = 3;                                   
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+2,#0x0030 ; [CPU_ALU] |187| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 188,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 188 | GpioCtrlRegs.GPAQSEL1.bit.GPIO3 = 3;                                   
; 190 | //                                                                     
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "../Common/F2837xD_I2C.c",line 198,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "../Common/F2837xD_I2C.c",line 199,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "../Common/F2837xD_I2C.c",line 201,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 201 | GpioCtrlRegs.GPAGMUX1.bit.GPIO3 = 1;                                   
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+32,#0xff3f ; [CPU_ALU] |201| 
        ORB       AL,#0x40              ; [CPU_ALU] |201| 
        MOV       @_GpioCtrlRegs+32,AL  ; [CPU_ALU] |201| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 202,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 202 | GpioCtrlRegs.GPAMUX1.bit.GPIO3  = 2;                                   
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+6,#0xff3f ; [CPU_ALU] |202| 
        ORB       AL,#0x80              ; [CPU_ALU] |202| 
        MOV       @_GpioCtrlRegs+6,AL   ; [CPU_ALU] |202| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 204,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 204 | break;                                                                 
; 206 | case I2C_B_GPIO134_GPIO35:                                             
; 207 | //                                                                     
; 208 | // Enable internal pull-up for the selected I2C pins                   
; 209 | //                                                                     
; 211 | //                                                                     
; 212 | // Set qualification for the selected I2C pins                         
; 213 | //                                                                     
; 215 | //                                                                     
; 216 | // Configure which of the possible GPIO pins will be I2C_B pins        
; 217 | // using GPIO regs                                                     
; 218 | //                                                                     
; 219 | break;                                                                 
; 221 | case I2C_B_GPIO40_GPIO41:                                              
; 222 | //                                                                     
; 223 | // Enable internal pull-up for the selected I2C pins                   
; 224 | //                                                                     
; 226 | //                                                                     
; 227 | // Set qualification for the selected I2C pins                         
; 228 | //                                                                     
; 230 | //                                                                     
; 231 | // Configure which of the possible GPIO pins will be I2C_B pins        
; 232 | // using GPIO regs                                                     
; 233 | //                                                                     
; 234 | break;                                                                 
; 236 | case I2C_B_GPIO66_GPIO69:                                              
; 237 | //                                                                     
; 238 | // Enable internal pull-up for the selected I2C pins                   
; 239 | //                                                                     
;----------------------------------------------------------------------
        B         $C$L10,UNC            ; [CPU_ALU] |204| 
        ; branch occurs ; [] |204| 
$C$L8:    
	.dwpsn	file "../Common/F2837xD_I2C.c",line 240,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 240 | GpioCtrlRegs.GPCPUD.bit.GPIO66 = 0;    //SDAB                          
;----------------------------------------------------------------------
        MOVW      DP,#_GpioCtrlRegs+140 ; [CPU_ARAU] 
        AND       @_GpioCtrlRegs+140,#0xfffb ; [CPU_ALU] |240| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 241,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 241 | GpioCtrlRegs.GPCPUD.bit.GPIO69 = 0;    //SCLB                          
; 243 | //                                                                     
; 244 | // Set qualification for the selected I2C pins                         
; 245 | //                                                                     
;----------------------------------------------------------------------
        AND       @_GpioCtrlRegs+140,#0xffdf ; [CPU_ALU] |241| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 246,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 246 | GpioCtrlRegs.GPCQSEL1.bit.GPIO66 = 3;                                  
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+130,#0x0030 ; [CPU_ALU] |246| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 247,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 247 | GpioCtrlRegs.GPCQSEL1.bit.GPIO69 = 3;                                  
; 249 | //                                                                     
; 250 | // Configure which of the possible GPIO pins will be I2C_B pins        
; 251 | // using GPIO regs                                                     
; 252 | //                                                                     
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+130,#0x0c00 ; [CPU_ALU] |247| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 253,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 253 | GpioCtrlRegs.GPCGMUX1.bit.GPIO66 = 1;    //0x6                         
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+160,#0xffcf ; [CPU_ALU] |253| 
        ORB       AL,#0x10              ; [CPU_ALU] |253| 
        MOV       @_GpioCtrlRegs+160,AL ; [CPU_ALU] |253| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 254,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 254 | GpioCtrlRegs.GPCMUX1.bit.GPIO66 = 2;                                   
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+134,#0xffcf ; [CPU_ALU] |254| 
        ORB       AL,#0x20              ; [CPU_ALU] |254| 
        MOV       @_GpioCtrlRegs+134,AL ; [CPU_ALU] |254| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 256,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 256 | GpioCtrlRegs.GPCGMUX1.bit.GPIO69 = 1;    //0x6                         
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+160,#0xf3ff ; [CPU_ALU] |256| 
        OR        AL,#0x0400            ; [CPU_ALU] |256| 
        MOV       @_GpioCtrlRegs+160,AL ; [CPU_ALU] |256| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 257,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 257 | GpioCtrlRegs.GPCMUX1.bit.GPIO69 = 2;                                   
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+134,#0xf3ff ; [CPU_ALU] |257| 
        OR        AL,#0x0800            ; [CPU_ALU] |257| 
        MOV       @_GpioCtrlRegs+134,AL ; [CPU_ALU] |257| 
	.dwpsn	file "../Common/F2837xD_I2C.c",line 258,column 13,is_stmt,isa 0
;----------------------------------------------------------------------
; 258 | break;                                                                 
; 260 | default:                                                               
; 261 | break;                                                                 
...
$C$L9:    
	.dwpsn	file "../Common/F2837xD_I2C.c",line 172,column 5,is_stmt,isa 0
        ...
        ; branchcc occurs ; [] |172| 
$C$L10:    
	.dwpsn	file "../Common/F2837xD_I2C.c",line 264,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 264 | EDIS;                                                                  
;----------------------------------------------------------------------
 EDIS
	.dwpsn	file "../Common/F2837xD_I2C.c",line 265,column 1,is_stmt,isa 0
        SUBB      SP,#2                 ; [CPU_ARAU] 
	.dwcfi	cfa_offset, -2
        SPM       #0                    ; [CPU_ALU] 
$C$DW$9	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$9, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$6, DW_AT_TI_end_file("../Common/F2837xD_I2C.c")
