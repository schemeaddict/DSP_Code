...
;* Date/Time created: Mon Apr 22 13:16:17 2019                 *
;***************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../Common/F2837xD_can.c")
...
;	C:\ti\ccsv8\tools\compiler\ti-cgt-c2000_18.1.4.LTS\bin\ac2000.exe -@C:\\Users\\Claudine\\AppData\\Local\\Temp\\{8ACA644E-F720-4D65-9E6E-2314FBE91A86} 
	.sect	".text"
	.clink
	.global	_InitCAN
...
$C$DW$2	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$2, DW_AT_TI_begin_file("../Common/F2837xD_can.c")
	.dwattr $C$DW$2, DW_AT_TI_begin_line(0x17)
	.dwattr $C$DW$2, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$2, DW_AT_TI_max_frame_size(-6)
	.dwpsn	file "../Common/F2837xD_can.c",line 24,column 1,is_stmt,address _InitCAN,isa 0

	.dwfde $C$DW$CIE, _InitCAN
;----------------------------------------------------------------------
;  23 | void InitCAN(void)                                                     
;  25 | int16_t iMsg;                                                          
;  27 | //                                                                     
;  28 | // Place CAN controller in init state, regardless of previous state.  T
;     | his                                                                    
;  29 | // will put controller in idle, and allow the message object RAM to be 
;  30 | // programmed.                                                         
;  31 | //                                                                     
;----------------------------------------------------------------------
...
$C$DW$4	.dwtag  DW_TAG_variable
	...
	.dwpsn	file "../Common/F2837xD_can.c",line 32,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  32 | CanaRegs.CAN_CTL.bit.Init = 1;                                         
;----------------------------------------------------------------------
        MOVW      DP,#_CanaRegs         ; [CPU_ARAU] 
        OR        @_CanaRegs,#0x0001    ; [CPU_ALU] |32| 
	.dwpsn	file "../Common/F2837xD_can.c",line 33,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  33 | CanaRegs.CAN_CTL.bit.SWR = 1;                                          
;  35 | //                                                                     
;  36 | // Wait for busy bit to clear                                          
;  37 | //                                                                     
;----------------------------------------------------------------------
        OR        @_CanaRegs,#0x8000    ; [CPU_ALU] |33| 
	.dwpsn	file "../Common/F2837xD_can.c",line 38,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  38 | while(CanaRegs.CAN_IF1CMD.bit.Busy)                                    
;  42 | //                                                                     
;  43 | // Clear the message value bit in the arbitration register.  This indic
;     | ates                                                                   
;  44 | // the message is not valid and is a "safe" condition to leave the mess
;     | age                                                                    
;  45 | // object.  The same arb reg is used to program all the message objects
;     | .                                                                      
;  46 | //                                                                     
;----------------------------------------------------------------------
$C$L1:    
        ...
        ; branchcc occurs ; [] |38| 
	.dwpsn	file "../Common/F2837xD_can.c",line 47,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  47 | CanaRegs.CAN_IF1CMD.bit.DIR = 1;                                       
;----------------------------------------------------------------------
        MOVL      XAR4,#_CanaRegs+256   ; [CPU_ARAU] |47| 
        MOVL      ACC,*+XAR4[0]         ; [CPU_ALU] |47| 
        OR        AH,#128               ; [CPU_ALU] |47| 
        MOVL      *+XAR4[0],ACC         ; [CPU_ALU] |47| 
	.dwpsn	file "../Common/F2837xD_can.c",line 48,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  48 | CanaRegs.CAN_IF1CMD.bit.Arb = 1;                                       
;----------------------------------------------------------------------
        MOVL      ACC,*+XAR4[0]         ; [CPU_ALU] |48| 
        OR        AH,#32                ; [CPU_ALU] |48| 
        MOVL      *+XAR4[0],ACC         ; [CPU_ALU] |48| 
	.dwpsn	file "../Common/F2837xD_can.c",line 49,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  49 | CanaRegs.CAN_IF1CMD.bit.Control = 1;                                   
;----------------------------------------------------------------------
        MOVL      ACC,*+XAR4[0]         ; [CPU_ALU] |49| 
        OR        AH,#16                ; [CPU_ALU] |49| 
        MOVL      *+XAR4[0],ACC         ; [CPU_ALU] |49| 
	.dwpsn	file "../Common/F2837xD_can.c",line 51,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  51 | CanaRegs.CAN_IF1ARB.all = 0;                                           
;----------------------------------------------------------------------
        MOVB      ACC,#0                ; [CPU_ALU] |51| 
        MOVL      XAR4,#_CanaRegs+264   ; [CPU_ARAU] |51| 
        MOVL      *+XAR4[0],ACC         ; [CPU_ALU] |51| 
	.dwpsn	file "../Common/F2837xD_can.c",line 53,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  53 | CanaRegs.CAN_IF1MCTL.all = 0;                                          
;----------------------------------------------------------------------
        MOVL      XAR4,#_CanaRegs+268   ; [CPU_ARAU] |53| 
        MOVL      *+XAR4[0],ACC         ; [CPU_ALU] |53| 
	.dwpsn	file "../Common/F2837xD_can.c",line 55,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  55 | CanaRegs.CAN_IF2CMD.bit.DIR = 1;                                       
;----------------------------------------------------------------------
        MOVL      XAR4,#_CanaRegs+288   ; [CPU_ARAU] |55| 
        MOVL      ACC,*+XAR4[0]         ; [CPU_ALU] |55| 
        OR        AH,#128               ; [CPU_ALU] |55| 
        MOVL      *+XAR4[0],ACC         ; [CPU_ALU] |55| 
	.dwpsn	file "../Common/F2837xD_can.c",line 56,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  56 | CanaRegs.CAN_IF2CMD.bit.Arb = 1;                                       
;----------------------------------------------------------------------
        MOVL      ACC,*+XAR4[0]         ; [CPU_ALU] |56| 
        OR        AH,#32                ; [CPU_ALU] |56| 
        MOVL      *+XAR4[0],ACC         ; [CPU_ALU] |56| 
	.dwpsn	file "../Common/F2837xD_can.c",line 57,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  57 | CanaRegs.CAN_IF2CMD.bit.Control = 1;                                   
;----------------------------------------------------------------------
        MOVL      ACC,*+XAR4[0]         ; [CPU_ALU] |57| 
        OR        AH,#16                ; [CPU_ALU] |57| 
        MOVL      *+XAR4[0],ACC         ; [CPU_ALU] |57| 
	.dwpsn	file "../Common/F2837xD_can.c",line 59,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  59 | CanaRegs.CAN_IF2ARB.all = 0;                                           
;----------------------------------------------------------------------
        MOVB      ACC,#0                ; [CPU_ALU] |59| 
        MOVL      XAR4,#_CanaRegs+296   ; [CPU_ARAU] |59| 
        MOVL      *+XAR4[0],ACC         ; [CPU_ALU] |59| 
	.dwpsn	file "../Common/F2837xD_can.c",line 61,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  61 | CanaRegs.CAN_IF2MCTL.all = 0;                                          
;  63 | //                                                                     
;  64 | // Loop through to program all 32 message objects                      
;  65 | //                                                                     
;----------------------------------------------------------------------
        MOVL      XAR4,#_CanaRegs+300   ; [CPU_ARAU] |61| 
        MOVL      *+XAR4[0],ACC         ; [CPU_ALU] |61| 
	.dwpsn	file "../Common/F2837xD_can.c",line 66,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
;  66 | for(iMsg = 1; iMsg <= 32; iMsg+=2)                                     
;----------------------------------------------------------------------
        MOVB      *-SP[3],#1,UNC        ; [CPU_ALU] |66| 
	.dwpsn	file "../Common/F2837xD_can.c",line 66,column 19,is_stmt,isa 0
;----------------------------------------------------------------------
;  68 | //                                                                     
;  69 | // Wait for busy bit to clear                                          
;  70 | //                                                                     
;----------------------------------------------------------------------
        ...
        ; branchcc occurs ; [] |66| 
	.dwpsn	file "../Common/F2837xD_can.c",line 71,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
;  71 | while(CanaRegs.CAN_IF1CMD.bit.Busy)                                    
;  75 | //                                                                     
;  76 | // Initiate programming the message object                             
;  77 | //                                                                     
;----------------------------------------------------------------------
$C$L2:    
        ...
        ; branchcc occurs ; [] |71| 
	.dwpsn	file "../Common/F2837xD_can.c",line 78,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
;  78 | CanaRegs.CAN_IF1CMD.bit.MSG_NUM = iMsg;                                
;  80 | //                                                                     
;  81 | // Wait for busy bit to clear                                          
;  82 | //                                                                     
;----------------------------------------------------------------------
	...
	.dwpsn	file "../Common/F2837xD_can.c",line 83,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
;  83 | while(CanaRegs.CAN_IF2CMD.bit.Busy)                                    
;  87 | //                                                                     
;  88 | // Initiate programming the message object                             
;  89 | //                                                                     
;----------------------------------------------------------------------
$C$L3:    
        ...
        ; branchcc occurs ; [] |83| 
	.dwpsn	file "../Common/F2837xD_can.c",line 90,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
;  90 | CanaRegs.CAN_IF2CMD.bit.MSG_NUM = iMsg + 1;                            
;  93 | //                                                                     
;  94 | // Acknowledge any pending status interrupts.                          
;  95 | //                                                                     
;----------------------------------------------------------------------
	...
	.dwpsn	file "../Common/F2837xD_can.c",line 66,column 31,is_stmt,isa 0
	...
	.dwpsn	file "../Common/F2837xD_can.c",line 66,column 19,is_stmt,isa 0
        ...
        ; branchcc occurs ; [] |66| 
$C$L4:    
	.dwpsn	file "../Common/F2837xD_can.c",line 96,column 35,is_stmt,isa 0
;----------------------------------------------------------------------
;  96 | volatile uint32_t discardRead = CanaRegs.CAN_ES.all;                   
;----------------------------------------------------------------------
        MOVL      XAR4,#_CanaRegs+4     ; [CPU_ARAU] |96| 
        MOVL      ACC,*+XAR4[0]         ; [CPU_ALU] |96| 
        MOVL      *-SP[2],ACC           ; [CPU_ALU] |96| 
	.dwpsn	file "../Common/F2837xD_can.c",line 98,column 1,is_stmt,isa 0
        SUBB      SP,#4                 ; [CPU_ARAU] 
	.dwcfi	cfa_offset, -2
$C$DW$5	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$5, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$2, DW_AT_TI_end_file("../Common/F2837xD_can.c")
