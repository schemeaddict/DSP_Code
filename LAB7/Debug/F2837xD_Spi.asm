...
;* Date/Time created: Tue Mar 19 21:36:32 2019                 *
;***************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../Common/F2837xD_Spi.c")
...
;	C:\ti\ccsv8\tools\compiler\ti-cgt-c2000_18.1.4.LTS\bin\ac2000.exe -@C:\\Users\\Claudine\\AppData\\Local\\Temp\\{4FAC2CBD-810A-49C5-9FA1-20671CC5E902} 
	.sect	".text"
	.clink
	.global	_InitSpi
...
$C$DW$3	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$3, DW_AT_TI_begin_file("../Common/F2837xD_Spi.c")
	.dwattr $C$DW$3, DW_AT_TI_begin_line(0x29)
	.dwattr $C$DW$3, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$3, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../Common/F2837xD_Spi.c",line 42,column 1,is_stmt,address _InitSpi,isa 0

	.dwfde $C$DW$CIE, _InitSpi
;----------------------------------------------------------------------
;  41 | void InitSpi(void)                                                     
;  43 | // Initialize SPI-A                                                    
;  45 | // Set reset low before configuration changes                          
;  46 | // Clock polarity (0 == rising, 1 == falling)                          
;  47 | // 16-bit character                                                    
;  48 | // Enable loop-back                                                    
;----------------------------------------------------------------------
...
_InitSpi:
	...
	.dwpsn	file "../Common/F2837xD_Spi.c",line 49,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  49 | SpiaRegs.SPICCR.bit.SPISWRESET = 0;                                    
;----------------------------------------------------------------------
        MOVW      DP,#_SpiaRegs         ; [CPU_ARAU] 
        AND       @_SpiaRegs,#0xff7f    ; [CPU_ALU] |49| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 50,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  50 | SpiaRegs.SPICCR.bit.CLKPOLARITY = 0;                                   
;----------------------------------------------------------------------
        AND       @_SpiaRegs,#0xffbf    ; [CPU_ALU] |50| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 51,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  51 | SpiaRegs.SPICCR.bit.SPICHAR = (16-1);                                  
;----------------------------------------------------------------------
        OR        @_SpiaRegs,#0x000f    ; [CPU_ALU] |51| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 52,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  52 | SpiaRegs.SPICCR.bit.SPILBK = 1;                                        
;  54 | // Enable master (0 == slave, 1 == master)                             
;  55 | // Enable transmission (Talk)                                          
;  56 | // Clock phase (0 == normal, 1 == delayed)                             
;  57 | // SPI interrupts are disabled                                         
;----------------------------------------------------------------------
        OR        @_SpiaRegs,#0x0010    ; [CPU_ALU] |52| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 58,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  58 | SpiaRegs.SPICTL.bit.MASTER_SLAVE = 1;                                  
;----------------------------------------------------------------------
        OR        @_SpiaRegs+1,#0x0004  ; [CPU_ALU] |58| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 59,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  59 | SpiaRegs.SPICTL.bit.TALK = 1;                                          
;----------------------------------------------------------------------
        OR        @_SpiaRegs+1,#0x0002  ; [CPU_ALU] |59| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 60,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  60 | SpiaRegs.SPICTL.bit.CLK_PHASE = 0;                                     
;----------------------------------------------------------------------
        AND       @_SpiaRegs+1,#0xfff7  ; [CPU_ALU] |60| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 61,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  61 | SpiaRegs.SPICTL.bit.SPIINTENA = 0;                                     
;  63 | // Set the baud rate                                                   
;----------------------------------------------------------------------
        AND       @_SpiaRegs+1,#0xfffe  ; [CPU_ALU] |61| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 64,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  64 | SpiaRegs.SPIBRR.bit.SPI_BIT_RATE = SPI_BRR;                            
;  66 | // Set FREE bit                                                        
;  67 | // Halting on a breakpoint will not halt the SPI                       
;----------------------------------------------------------------------
        AND       AL,@_SpiaRegs+4,#0xff80 ; [CPU_ALU] |64| 
        ORB       AL,#0x63              ; [CPU_ALU] |64| 
        MOV       @_SpiaRegs+4,AL       ; [CPU_ALU] |64| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 68,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  68 | SpiaRegs.SPIPRI.bit.FREE = 1;                                          
;  70 | // Release the SPI from reset                                          
;----------------------------------------------------------------------
        OR        @_SpiaRegs+15,#0x0010 ; [CPU_ALU] |68| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 71,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  71 | SpiaRegs.SPICCR.bit.SPISWRESET = 1;                                    
;----------------------------------------------------------------------
        OR        @_SpiaRegs,#0x0080    ; [CPU_ALU] |71| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 72,column 1,is_stmt,isa 0
$C$DW$4	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$4, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$3, DW_AT_TI_end_file("../Common/F2837xD_Spi.c")
...
$C$DW$5	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$5, DW_AT_TI_begin_file("../Common/F2837xD_Spi.c")
	.dwattr $C$DW$5, DW_AT_TI_begin_line(0x58)
	.dwattr $C$DW$5, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$5, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../Common/F2837xD_Spi.c",line 89,column 1,is_stmt,address _InitSpiGpio,isa 0
...
_InitSpiGpio:
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwpsn	file "../Common/F2837xD_Spi.c",line 90,column 4,is_stmt,isa 0
;----------------------------------------------------------------------
;  90 | InitSpiaGpio();                                                        
;----------------------------------------------------------------------
$C$DW$6	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Common/F2837xD_Spi.c",line 91,column 1,is_stmt,isa 0
$C$DW$7	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$7, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$5, DW_AT_TI_end_file("../Common/F2837xD_Spi.c")
...
$C$DW$8	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$8, DW_AT_TI_begin_file("../Common/F2837xD_Spi.c")
	.dwattr $C$DW$8, DW_AT_TI_begin_line(0x60)
	.dwattr $C$DW$8, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$8, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../Common/F2837xD_Spi.c",line 97,column 1,is_stmt,address _InitSpiaGpio,isa 0

	.dwfde $C$DW$CIE, _InitSpiaGpio
;----------------------------------------------------------------------
;  96 | void InitSpiaGpio()                                                    
;----------------------------------------------------------------------
...
_InitSpiaGpio:
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwpsn	file "../Common/F2837xD_Spi.c",line 98,column 4,is_stmt,isa 0
;----------------------------------------------------------------------
;  98 | EALLOW;                                                                
; 100 |  //                                                                    
; 101 |  // Enable internal pull-up for the selected pins                      
; 102 |  //                                                                    
; 103 |  // Pull-ups can be enabled or disabled by the user.                   
; 104 |  // This will enable the pullups for the specified pins.               
; 105 |  // Comment out other unwanted lines.                                  
; 106 |  //                                                                    
;----------------------------------------------------------------------
 EALLOW
	.dwpsn	file "../Common/F2837xD_Spi.c",line 107,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 107 | GpioCtrlRegs.GPAPUD.bit.GPIO16 = 0;  // Enable pull-up on GPIO16 (SPISI
;     | MOA)                                                                   
; 108 | //  GpioCtrlRegs.GPAPUD.bit.GPIO5 = 0;   // Enable pull-up on GPIO5 (SP
;     | ISIMOA)                                                                
;----------------------------------------------------------------------
        MOVW      DP,#_GpioCtrlRegs+13  ; [CPU_ARAU] 
        AND       @_GpioCtrlRegs+13,#0xfffe ; [CPU_ALU] |107| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 109,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 109 | GpioCtrlRegs.GPAPUD.bit.GPIO17 = 0;  // Enable pull-up on GPIO17 (SPISO
;     | MIA)                                                                   
; 110 | //  GpioCtrlRegs.GPAPUD.bit.GPIO3 = 0;   // Enable pull-up on GPIO3 (SP
;     | ISOMIA)                                                                
;----------------------------------------------------------------------
        AND       @_GpioCtrlRegs+13,#0xfffd ; [CPU_ALU] |109| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 111,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 111 | GpioCtrlRegs.GPAPUD.bit.GPIO18 = 0;  // Enable pull-up on GPIO18 (SPICL
;     | KA)                                                                    
;----------------------------------------------------------------------
        AND       @_GpioCtrlRegs+13,#0xfffb ; [CPU_ALU] |111| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 112,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 112 | GpioCtrlRegs.GPAPUD.bit.GPIO19 = 0;  // Enable pull-up on GPIO19 (SPIST
;     | EA)                                                                    
; 114 | //                                                                     
; 115 | // Set qualification for selected pins to asynch only                  
; 116 | //                                                                     
; 117 | // This will select asynch (no qualification) for the selected pins.   
; 118 | // Comment out other unwanted lines.                                   
; 119 | //                                                                     
;----------------------------------------------------------------------
        AND       @_GpioCtrlRegs+13,#0xfff7 ; [CPU_ALU] |112| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 120,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 120 | GpioCtrlRegs.GPAQSEL2.bit.GPIO16 = 3; // Asynch input GPIO16 (SPISIMOA)
; 121 | //  GpioCtrlRegs.GPAQSEL1.bit.GPIO5 = 3;  // Asynch input GPIO5 (SPISIM
;     | OA)                                                                    
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+4,#0x0003 ; [CPU_ALU] |120| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 122,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 122 | GpioCtrlRegs.GPAQSEL2.bit.GPIO17 = 3; // Asynch input GPIO17 (SPISOMIA)
; 123 | //  GpioCtrlRegs.GPAQSEL1.bit.GPIO3 = 3;  // Asynch input GPIO3 (SPISOM
;     | IA)                                                                    
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+4,#0x000c ; [CPU_ALU] |122| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 124,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 124 | GpioCtrlRegs.GPAQSEL2.bit.GPIO18 = 3; // Asynch input GPIO18 (SPICLKA) 
;----------------------------------------------------------------------
        OR        @_GpioCtrlRegs+4,#0x0030 ; [CPU_ALU] |124| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 125,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 125 | GpioCtrlRegs.GPAQSEL2.bit.GPIO19 = 3; // Asynch input GPIO19 (SPISTEA) 
; 127 | //                                                                     
; 128 | //Configure SPI-A pins using GPIO regs                                 
; 129 | //                                                                     
; 130 | // This specifies which of the possible GPIO pins will be SPI functiona
;     | l                                                                      
; 131 | // pins.                                                               
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "../Common/F2837xD_Spi.c",line 134,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 134 | GpioCtrlRegs.GPAMUX2.bit.GPIO16 = 1; // Configure GPIO16 as SPISIMOA   
; 135 | //  GpioCtrlRegs.GPAMUX1.bit.GPIO5 = 2;  // Configure GPIO5 as SPISIMOA
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+8,#0xfffc ; [CPU_ALU] |134| 
        ORB       AL,#0x01              ; [CPU_ALU] |134| 
        MOV       @_GpioCtrlRegs+8,AL   ; [CPU_ALU] |134| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 136,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 136 | GpioCtrlRegs.GPAMUX2.bit.GPIO17 = 1; // Configure GPIO17 as SPISOMIA   
; 137 | //  GpioCtrlRegs.GPAMUX1.bit.GPIO3 = 2;  // Configure GPIO3 as SPISOMIA
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+8,#0xfff3 ; [CPU_ALU] |136| 
        ORB       AL,#0x04              ; [CPU_ALU] |136| 
        MOV       @_GpioCtrlRegs+8,AL   ; [CPU_ALU] |136| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 138,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 138 | GpioCtrlRegs.GPAMUX2.bit.GPIO18 = 1; // Configure GPIO18 as SPICLKA    
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+8,#0xffcf ; [CPU_ALU] |138| 
        ORB       AL,#0x10              ; [CPU_ALU] |138| 
        MOV       @_GpioCtrlRegs+8,AL   ; [CPU_ALU] |138| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 139,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 139 | GpioCtrlRegs.GPAMUX2.bit.GPIO19 = 1; // Configure GPIO19 as SPISTEA    
;----------------------------------------------------------------------
        AND       AL,@_GpioCtrlRegs+8,#0xff3f ; [CPU_ALU] |139| 
        ORB       AL,#0x40              ; [CPU_ALU] |139| 
        MOV       @_GpioCtrlRegs+8,AL   ; [CPU_ALU] |139| 
	.dwpsn	file "../Common/F2837xD_Spi.c",line 141,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 141 | EDIS;                                                                  
;----------------------------------------------------------------------
 EDIS
	.dwpsn	file "../Common/F2837xD_Spi.c",line 142,column 1,is_stmt,isa 0
        SPM       #0                    ; [CPU_ALU] 
$C$DW$9	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$9, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$8, DW_AT_TI_end_file("../Common/F2837xD_Spi.c")
