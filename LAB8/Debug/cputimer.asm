...
;* Date/Time created: Sat Feb 23 19:22:04 2019                 *
;***************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../driverlib/cputimer.c")
...
;	C:\ti\ccsv8\tools\compiler\ti-cgt-c2000_18.1.4.LTS\bin\ac2000.exe -@C:\\Users\\Claudine\\AppData\\Local\\Temp\\{05078249-96A1-4914-94BA-D8CC158CE26E} 
	.sect	".text"
	.clink
	.global	_CPUTimer_setEmulationMode

$C$DW$1	.dwtag  DW_TAG_subprogram
	.dwattr $C$DW$1, DW_AT_name("CPUTimer_setEmulationMode")
	.dwattr $C$DW$1, DW_AT_low_pc(_CPUTimer_setEmulationMode)
	.dwattr $C$DW$1, DW_AT_high_pc(0x00)
	.dwattr $C$DW$1, DW_AT_TI_symbol_name("_CPUTimer_setEmulationMode")
	.dwattr $C$DW$1, DW_AT_external
	.dwattr $C$DW$1, DW_AT_TI_begin_file("../driverlib/cputimer.c")
	.dwattr $C$DW$1, DW_AT_TI_begin_line(0x32)
	.dwattr $C$DW$1, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$1, DW_AT_TI_max_frame_size(-6)
	.dwpsn	file "../driverlib/cputimer.c",line 51,column 1,is_stmt,address _CPUTimer_setEmulationMode,isa 0

	.dwfde $C$DW$CIE, _CPUTimer_setEmulationMode
...
$C$DW$3	.dwtag  DW_TAG_formal_parameter
	...
	.dwattr $C$DW$3, DW_AT_TI_symbol_name("_mode")
	.dwattr $C$DW$3, DW_AT_type(*$C$DW$T$20)
	.dwattr $C$DW$3, DW_AT_location[DW_OP_reg12]

;----------------------------------------------------------------------
;  50 | void CPUTimer_setEmulationMode(uint32_t base, CPUTimer_EmulationMode mo
;     | de)                                                                    
;----------------------------------------------------------------------

;***************************************************************
;* FNAME: _CPUTimer_setEmulationMode    FR SIZE:   4           *
;*                                                             *
...
;----------------------------------------------------------------------
;  52 | ASSERT(CPUTimer_isBaseValid(base));                                    
;  53 | // Write to FREE_SOFT bits of register TCR                             
;----------------------------------------------------------------------
        MOV       *-SP[3],AR4           ; [CPU_ALU] |51| 
        MOVL      *-SP[2],ACC           ; [CPU_ALU] |51| 
	.dwpsn	file "../driverlib/cputimer.c",line 54,column 7,is_stmt,isa 0
;----------------------------------------------------------------------
;  54 | HWREGH(base + CPUTIMER_O_TCR) =                                        
;  55 |       (HWREGH(base + CPUTIMER_O_TCR) &                                 
;  56 |       ~(CPUTIMER_TCR_FREE | CPUTIMER_TCR_SOFT)) |                      
;  57 |       (uint16_t)mode;                                                  
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[2]          ; [CPU_ALU] |54| 
        AND       AL,*+XAR4[4],#0xf3ff  ; [CPU_ALU] |54| 
        OR        AL,*-SP[3]            ; [CPU_ALU] |54| 
        MOV       *+XAR4[4],AL          ; [CPU_ALU] |54| 
	.dwpsn	file "../driverlib/cputimer.c",line 58,column 1,is_stmt,isa 0
        SUBB      SP,#4                 ; [CPU_ARAU] 
	.dwcfi	cfa_offset, -2
$C$DW$6	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$6, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$1, DW_AT_TI_end_file("../driverlib/cputimer.c")
