...
;* Date/Time created: Mon Apr 22 05:48:31 2019                 *
;***************************************************************
...
;	C:\ti\ccsv8\tools\compiler\ti-cgt-c2000_18.1.4.LTS\bin\ac2000.exe -@C:\\Users\\Claudine\\AppData\\Local\\Temp\\{F248FF74-710D-4452-B2D3-ED491463A65A} 
	.sect	".text"
	.clink
	.global	_new_buffer
...
$C$DW$8	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Buffers/buffer.c",line 7,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;   7 | return newBuff;                                                        
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[2]          ; [CPU_ALU] |7| 
	.dwpsn	file "../Buffers/buffer.c",line 8,column 1,is_stmt,isa 0
        SUBB      SP,#4                 ; [CPU_ARAU] 
	.dwcfi	cfa_offset, -2
$C$DW$9	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$3, DW_AT_TI_end_line(0x08)
